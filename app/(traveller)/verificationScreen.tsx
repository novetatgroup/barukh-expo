...
const VerificationScreen = () => {
  ...
  const handleVerify = () => {
    if (code.length !== 6) {
      Alert.alert("Invalid code", "Enter the 6 digit sender code to continue.");
      return;
    }
  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Enter sender code</Text>
        <Text style={styles.subtitle}>
          Ask the sender for the 6 digit handoff code before uploading proof of delivery.
        </Text>
